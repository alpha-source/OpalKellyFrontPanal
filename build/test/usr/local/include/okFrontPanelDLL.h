...
// FRONTPANELDLL_EXPORTS symbol defined on the command line.  This symbol should
...
inline LONG WINAPI
ok_DelayLoadDllExceptionFilter(PEXCEPTION_POINTERS pExcPointers) {
...
typedef void (*okScriptEngineAsyncCallback)(void *, const char *,
                                            okScriptValues_HANDLE);
...
#define MAX_SERIALNUMBER_LENGTH                                                \
  10 // 10 characters + Does NOT include termination NULL.
#define MAX_DEVICEID_LENGTH                                                    \
  32 // 32 characters + Does NOT include termination NULL.
#define MAX_BOARDMODELSTRING_LENGTH                                            \
  64 // 64 characters including termination NULL.
...
typedef enum { ok_DivSrc_Ref = 0, ok_DivSrc_VCO = 1 } ok_DividerSource;
...
#define OK_MAX_DEVICE_SENSOR_DESCRIPTION_LENGTH                                \
  (256) // including NULL termination
typedef struct {
  int id;
...
okDLLEXPORT Bool DLL_ENTRY okFrontPanelDLL_CheckAPIVersion(int major, int minor,
                                                           int micro);
...
okDLLEXPORT Bool DLL_ENTRY okPLL22393_SetPLLParameters(okPLL22393_HANDLE pll,
                                                       int n, int p, int q,
                                                       Bool enable);
okDLLEXPORT Bool DLL_ENTRY okPLL22393_SetPLLLF(okPLL22393_HANDLE pll, int n,
                                               int lf);
okDLLEXPORT Bool DLL_ENTRY okPLL22393_SetOutputDivider(okPLL22393_HANDLE pll,
                                                       int n, int div);
okDLLEXPORT Bool DLL_ENTRY okPLL22393_SetOutputSource(
    okPLL22393_HANDLE pll, int n, ok_ClockSource_22393 clksrc);
...
okDLLEXPORT void DLL_ENTRY okPLL22150_SetOutputSource(
    okPLL22150_HANDLE pll, int output, ok_ClockSource_22150 clksrc);
...
okDeviceSensors_GetSensorCount(okDeviceSensors_HANDLE hnd);
okDLLEXPORT okTDeviceSensor DLL_ENTRY
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okDeviceSettings_GetString(
    okDeviceSettings_HANDLE hnd, const char *key, int length, char *buf);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okDeviceSettings_SetString(
    okDeviceSettings_HANDLE hnd, const char *key, const char *buf);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okDeviceSettings_GetInt(
    okDeviceSettings_HANDLE hnd, const char *key, UINT32 *value);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okDeviceSettings_SetInt(
    okDeviceSettings_HANDLE hnd, const char *key, UINT32 value);
...
//
okDLLEXPORT okFirmwarePackage_HANDLE DLL_ENTRY
okFirmwarePackage_Load(const char *filename);
okDLLEXPORT void DLL_ENTRY
okFirmwarePackage_Destruct(okFirmwarePackage_HANDLE hnd);
okDLLEXPORT int DLL_ENTRY
okFirmwarePackage_GetFirmwareCount(okFirmwarePackage_HANDLE hnd);
okDLLEXPORT okFirmware_HANDLE DLL_ENTRY
okFirmwarePackage_GetFirmware(okFirmwarePackage_HANDLE hnd, int num);

typedef void (*okFirmware_PerformTasks_Callback)(void *, int, const char *);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFirmware_PerformTasks(okFirmware_HANDLE hnd, const char *serial,
                        okFirmware_PerformTasks_Callback callback, void *arg);

//
// okBuffer
//
okDLLEXPORT okBuffer_HANDLE DLL_ENTRY okBuffer_Construct(unsigned size);
okDLLEXPORT okBuffer_HANDLE DLL_ENTRY okBuffer_FromData(void *ptr,
                                                        unsigned size);
...
// okScriptValue
//
okDLLEXPORT okScriptValue_HANDLE DLL_ENTRY
okScriptValue_Copy(okScriptValue_HANDLE h);
okDLLEXPORT okScriptValue_HANDLE DLL_ENTRY
okScriptValue_NewString(const char *s);
...
okDLLEXPORT okScriptValue_HANDLE DLL_ENTRY
okScriptValue_NewBuffer(okBuffer_HANDLE buf);
okDLLEXPORT okBool DLL_ENTRY okScriptValue_GetAsString(okScriptValue_HANDLE h,
                                                       const char **ps);
okDLLEXPORT okBool DLL_ENTRY okScriptValue_GetAsBool(okScriptValue_HANDLE h,
                                                     okBool *pb);
okDLLEXPORT okBool DLL_ENTRY okScriptValue_GetAsInt(okScriptValue_HANDLE h,
                                                    int *pn);
okDLLEXPORT okBool DLL_ENTRY okScriptValue_GetAsBuffer(okScriptValue_HANDLE h,
                                                       okBuffer_HANDLE *pbuf);
...
okDLLEXPORT okScriptValues_HANDLE DLL_ENTRY
okScriptValues_Copy(okScriptValues_HANDLE h);
...
okDLLEXPORT void DLL_ENTRY okScriptValues_Add(okScriptValues_HANDLE hnd,
                                              okScriptValue_HANDLE arg);
...
okDLLEXPORT int DLL_ENTRY okFrontPanel_GetErrorString(int ec, char *buf,
                                                      int length);
okDLLEXPORT const char *DLL_ENTRY
okFrontPanel_GetLastErrorMessage(okFrontPanel_HANDLE hnd);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_AddCustomDevice(
    const okTDeviceMatchInfo *matchInfo, const okTDeviceInfo *devInfo);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_RemoveCustomDevice(int productID);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_WriteI2C(
    okFrontPanel_HANDLE hnd, const int addr, int length, unsigned char *data);
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_FlashWrite(
    okFrontPanel_HANDLE hnd, UINT32 address, UINT32 length, const UINT8 *buf);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_FlashRead(
    okFrontPanel_HANDLE hnd, UINT32 address, UINT32 length, UINT8 *buf);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetFPGAResetProfile(
    okFrontPanel_HANDLE hnd, ok_FPGAConfigurationMethod method,
    okTFPGAResetProfile *profile);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetFPGAResetProfileWithSize(
    okFrontPanel_HANDLE hnd, ok_FPGAConfigurationMethod method,
    okTFPGAResetProfile *profile, unsigned size);
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_SetFPGAResetProfileWithSize(
    okFrontPanel_HANDLE hnd, ok_FPGAConfigurationMethod method,
    const okTFPGAResetProfile *profile, unsigned size);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_ReadRegister(okFrontPanel_HANDLE hnd, UINT32 addr, UINT32 *data);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_ReadRegisters(
    okFrontPanel_HANDLE hnd, unsigned num, okTRegisterEntry *regs);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_WriteRegister(okFrontPanel_HANDLE hnd, UINT32 addr, UINT32 data);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_WriteRegisters(
    okFrontPanel_HANDLE hnd, unsigned num, const okTRegisterEntry *regs);
okDLLEXPORT int DLL_ENTRY
...
okDLLEXPORT void DLL_ENTRY okFrontPanel_GetBoardModelString(
    okFrontPanel_HANDLE hnd, ok_BoardModel m, char *buf);
...
okDLLEXPORT void DLL_ENTRY okFrontPanel_GetSerialNumber(okFrontPanel_HANDLE hnd,
                                                        char *buf);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetDeviceSensors(
    okFrontPanel_HANDLE hnd, okDeviceSensors_HANDLE settings);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetDeviceSettings(
    okFrontPanel_HANDLE hnd, okDeviceSettings_HANDLE settings);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_GetDeviceInfo(okFrontPanel_HANDLE hnd, okTDeviceInfo *info);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetDeviceInfoWithSize(
    okFrontPanel_HANDLE hnd, okTDeviceInfo *info, unsigned size);
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_ConfigureFPGAWithReset(
    okFrontPanel_HANDLE hnd, const char *strFilename,
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_ConfigureFPGAFromMemoryWithReset(okFrontPanel_HANDLE hnd,
                                              unsigned char *data,
                                              unsigned long length,
                                              const okTFPGAResetProfile *reset);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_ConfigureFPGAFromFlash(
    okFrontPanel_HANDLE hnd, unsigned long configIndex);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetPLL22150Configuration(
    okFrontPanel_HANDLE hnd, okPLL22150_HANDLE pll);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_SetPLL22150Configuration(
    okFrontPanel_HANDLE hnd, okPLL22150_HANDLE pll);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetEepromPLL22150Configuration(
    okFrontPanel_HANDLE hnd, okPLL22150_HANDLE pll);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_SetEepromPLL22150Configuration(
    okFrontPanel_HANDLE hnd, okPLL22150_HANDLE pll);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetPLL22393Configuration(
    okFrontPanel_HANDLE hnd, okPLL22393_HANDLE pll);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_SetPLL22393Configuration(
    okFrontPanel_HANDLE hnd, okPLL22393_HANDLE pll);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_GetEepromPLL22393Configuration(
    okFrontPanel_HANDLE hnd, okPLL22393_HANDLE pll);
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_SetEepromPLL22393Configuration(
    okFrontPanel_HANDLE hnd, okPLL22393_HANDLE pll);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_SetWireInValue(
    okFrontPanel_HANDLE hnd, int ep, unsigned long val, unsigned long mask);
...
okDLLEXPORT long DLL_ENTRY okFrontPanel_WriteToBlockPipeIn(
    okFrontPanel_HANDLE hnd, int epAddr, int blockSize, long length,
    unsigned char *data);
...
// okScriptEngine
//
okDLLEXPORT okScriptEngine_HANDLE DLL_ENTRY
...
okDLLEXPORT Bool DLL_ENTRY okScriptEngine_LoadScript(okScriptEngine_HANDLE hnd,
                                                     const char *name,
                                                     const char *code,
                                                     okError **err);
okDLLEXPORT Bool DLL_ENTRY okScriptEngine_LoadFile(okScriptEngine_HANDLE hnd,
                                                   const char *path,
                                                   okError **err);
okDLLEXPORT void DLL_ENTRY
...
okDLLEXPORT Bool DLL_ENTRY okScriptEngine_RunScriptFunction(
    okScriptEngine_HANDLE hnd, const char *name, okScriptValues_HANDLE *retval,
    okScriptValues_HANDLE args, okError **err);
okDLLEXPORT Bool DLL_ENTRY okScriptEngine_RunScriptFunctionAsync(
    okScriptEngine_HANDLE hnd, okScriptEngineAsyncCallback callback, void *data,
    const char *name, okScriptValues_HANDLE args, okError **err);

//
// okFrontPanelManager
//
okDLLEXPORT okCFrontPanelManager_HANDLE DLL_ENTRY okFrontPanelManager_Construct(
    okFrontPanelManager_HANDLE self, const char *realm);
okDLLEXPORT void DLL_ENTRY
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanelManager_StartMonitoringWithCBInfo(okCFrontPanelManager_HANDLE hnd,
                                              okTCallbackInfo *cbInfo);
...
okDLLEXPORT void DLL_ENTRY okFrontPanelManager_ExitMonitorLoop(
    okCFrontPanelManager_HANDLE hnd, int exitCode);
...
okDLLEXPORT void DLL_ENTRY
okFrontPanelDevices_Destruct(okCFrontPanelDevices_HANDLE hnd);
okDLLEXPORT int DLL_ENTRY
okFrontPanelDevices_GetCount(okCFrontPanelDevices_HANDLE hnd);
okDLLEXPORT void DLL_ENTRY okFrontPanelDevices_GetSerial(
    okCFrontPanelDevices_HANDLE hnd, int num, char *buf);
okDLLEXPORT okFrontPanel_HANDLE DLL_ENTRY
...
public:
  ...
  enum DividerSource { DivSrc_Ref = 0, DivSrc_VCO = 1 };
...
public:
  ...
  static ErrorCode AddCustomDevice(const okTDeviceMatchInfo &matchInfo,
  ...
  int GetDeviceCount();
  ErrorCode GetFPGAResetProfile(okEFPGAConfigurationMethod method,
                                okTFPGAResetProfile *profile);
  ErrorCode SetFPGAResetProfile(okEFPGAConfigurationMethod method,
                                const okTFPGAResetProfile *profile);
  ...
  ErrorCode ConfigureFPGAWithReset(const std::string &strFilename,
                                   const okTFPGAResetProfile *reset);
  ErrorCode ConfigureFPGAFromMemory(unsigned char *data,
                                    const unsigned long length);
  ErrorCode ConfigureFPGAFromMemoryWithReset(unsigned char *data,
                                             const unsigned long length,
                                             const okTFPGAResetProfile *reset);
  ...
  long WriteToBlockPipeIn(int epAddr, int blockSize, long length,
                          unsigned char *data);
  long ReadFromBlockPipeOut(int epAddr, int blockSize, long length,
                            unsigned char *data);
};
...
public:
  ...
  okCFrontPanel::ErrorCode GetString(const std::string &key,
                                     std::string *value) {
    char buf[256];
    ok_ErrorCode rc =
        okDeviceSettings_GetString(h, key.c_str(), sizeof(buf), buf);
    if (rc == ok_NoError) {
      if (!value)
  ...
  okCFrontPanel::ErrorCode SetString(const std::string &key,
...
inline const char *GetAPIVersionString() {
  return okFrontPanelDLL_GetAPIVersionString();
}
...
class Firmware {
public:
  bool PerformTasks(const std::string &serial,
                    okFirmware_PerformTasks_Callback callback = NULL,
                    void *arg = NULL) {
    return h && okFirmware_PerformTasks(h, serial.c_str(), callback, arg) ==
                    ok_NoError;
  }
...
public:
  ...
  ScriptValues RunScriptFunction(const std::string &name,
  ...
  void RunScriptFunctionAsync(AsyncResultHandler &handler,
...
private:
  ...
  static void AsyncResultCallback(void *handler, const char *error,
                                  okScriptValues_HANDLE retvals) {
    return static_cast<AsyncResultHandler *>(handler)->OnResult(
        error, ScriptValues(retvals));
  }
...
inline void okCPLL22150::SetOutputSource(int output,
                                         okCPLL22150::ClockSource clksrc) {
...
inline bool okCPLL22393::SetOutputSource(int n,
                                         okCPLL22393::ClockSource clksrc) {
...
okCFrontPanel::AddCustomDevice(const okTDeviceMatchInfo &matchInfo,
                               const okTDeviceInfo *devInfo) {
  return (okCFrontPanel::ErrorCode)okFrontPanel_AddCustomDevice(&matchInfo,
                                                                devInfo);
}
inline okCFrontPanel::ErrorCode
...
okCFrontPanel::GetDeviceInfo(okTDeviceInfo *info) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_GetDeviceInfoWithSize(
      h, info, sizeof(*info)));
}
...
okCFrontPanel::SetBTPipePollingInterval(int interval) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_SetBTPipePollingInterval(
      h, interval));
}
...
okCFrontPanel::ConfigureFPGA(const std::string &strFilename) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_ConfigureFPGA(
      h, strFilename.c_str()));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ConfigureFPGAWithReset(const std::string &strFilename,
                                      const okTFPGAResetProfile *reset) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_ConfigureFPGAWithReset(
      h, strFilename.c_str(), reset));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ConfigureFPGAFromMemory(unsigned char *data,
                                       const unsigned long length) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_ConfigureFPGAFromMemory(
      h, data, length));
}
inline okCFrontPanel::ErrorCode okCFrontPanel::ConfigureFPGAFromMemoryWithReset(
    unsigned char *data, const unsigned long length,
    const okTFPGAResetProfile *reset) {
  return (
      (okCFrontPanel::ErrorCode)okFrontPanel_ConfigureFPGAFromMemoryWithReset(
          h, data, length, reset));
}
inline okCFrontPanel::ErrorCode
...
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetFPGAResetProfile(okEFPGAConfigurationMethod method,
                                   okTFPGAResetProfile *profile) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_GetFPGAResetProfileWithSize(
      h, method, profile, sizeof(*profile)));
}
inline okCFrontPanel::ErrorCode okCFrontPanel::ReadRegister(UINT32 addr,
                                                            UINT32 *data) {
...
okCFrontPanel::ReadRegisters(std::vector<okTRegisterEntry> &regs) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_ReadRegisters(
      h, (unsigned int)regs.size(), regs.empty() ? NULL : &regs[0]));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetFPGAResetProfile(okEFPGAConfigurationMethod method,
                                   const okTFPGAResetProfile *profile) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_SetFPGAResetProfileWithSize(
      h, method, profile, sizeof(*profile)));
}
inline okCFrontPanel::ErrorCode
...
okCFrontPanel::FlashWrite(UINT32 address, UINT32 length, const UINT8 *buf) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_FlashWrite(h, address, length,
                                                            buf));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::FlashRead(UINT32 address, UINT32 length, UINT8 *buf) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_FlashRead(h, address, length,
                                                           buf));
}
inline okCFrontPanel::ErrorCode okCFrontPanel::WriteRegister(UINT32 addr,
                                                             UINT32 data) {
...
okCFrontPanel::WriteRegisters(const std::vector<okTRegisterEntry> &regs) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_WriteRegisters(
      h, (unsigned int)regs.size(), regs.empty() ? NULL : &regs[0]));
}
inline okCFrontPanel::ErrorCode okCFrontPanel::GetWireInValue(int epAddr,
                                                              UINT32 *val) {
  return (
      (okCFrontPanel::ErrorCode)okFrontPanel_GetWireInValue(h, epAddr, val));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::WriteI2C(const int addr, int length, unsigned char *data) {
  return (
      (okCFrontPanel::ErrorCode)okFrontPanel_WriteI2C(h, addr, length, data));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ReadI2C(const int addr, int length, unsigned char *data) {
  return (
      (okCFrontPanel::ErrorCode)okFrontPanel_ReadI2C(h, addr, length, data));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetPLL22150Configuration(okCPLL22150 &pll) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_GetPLL22150Configuration(
      h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetPLL22150Configuration(okCPLL22150 &pll) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_SetPLL22150Configuration(
      h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetEepromPLL22150Configuration(okCPLL22150 &pll) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_GetEepromPLL22150Configuration(
      h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetEepromPLL22150Configuration(okCPLL22150 &pll) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_SetEepromPLL22150Configuration(
      h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetPLL22393Configuration(okCPLL22393 &pll) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_GetPLL22393Configuration(
      h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetPLL22393Configuration(okCPLL22393 &pll) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_SetPLL22393Configuration(
      h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::GetEepromPLL22393Configuration(okCPLL22393 &pll) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_GetEepromPLL22393Configuration(
      h, pll.h));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::SetEepromPLL22393Configuration(okCPLL22393 &pll) {
  return ((okCFrontPanel::ErrorCode)okFrontPanel_SetEepromPLL22393Configuration(
      h, pll.h));
}
inline okCFrontPanel::ErrorCode okCFrontPanel::LoadDefaultPLLConfiguration() {
  return (
      (okCFrontPanel::ErrorCode)okFrontPanel_LoadDefaultPLLConfiguration(h));
}
...
okCFrontPanel::SetWireInValue(int ep, UINT32 val, UINT32 mask) {
  return (
      (okCFrontPanel::ErrorCode)okFrontPanel_SetWireInValue(h, ep, val, mask));
}
...
inline okCFrontPanel::ErrorCode okCFrontPanel::ActivateTriggerIn(int epAddr,
                                                                 int bit) {
  return (
      (okCFrontPanel::ErrorCode)okFrontPanel_ActivateTriggerIn(h, epAddr, bit));
}
...
inline long okCFrontPanel::WriteToPipeIn(int epAddr, long length,
                                         unsigned char *data) {
  return (okFrontPanel_WriteToPipeIn(h, epAddr, length, data));
}
inline long okCFrontPanel::ReadFromPipeOut(int epAddr, long length,
                                           unsigned char *data) {
  return (okFrontPanel_ReadFromPipeOut(h, epAddr, length, data));
}
inline long okCFrontPanel::WriteToBlockPipeIn(int epAddr, int blockSize,
                                              long length,
                                              unsigned char *data) {
  return (okFrontPanel_WriteToBlockPipeIn(h, epAddr, blockSize, length, data));
}
inline long okCFrontPanel::ReadFromBlockPipeOut(int epAddr, int blockSize,
                                                long length,
                                                unsigned char *data) {
  return (
      okFrontPanel_ReadFromBlockPipeOut(h, epAddr, blockSize, length, data));
}
...
inline bool Buffer::IsEmpty() const { return okBuffer_IsEmpty(h); }
inline size_t Buffer::GetSize() const { return okBuffer_GetSize(h); }
inline unsigned char *Buffer::GetData() const { return okBuffer_GetData(h); }
inline Buffer::~Buffer() { okBuffer_Destruct(h); }
...
inline ScriptValue::~ScriptValue() { okScriptValue_Destruct(h); }
...
inline void ScriptValues::Clear() { okScriptValues_Clear(h); }
...
inline int ScriptValues::GetCount() const { return okScriptValues_GetCount(h); }
...
inline ScriptValues::~ScriptValues() { okScriptValues_Destruct(h); }

inline ScriptEngine::ScriptEngine() : h(NULL) {}
...
inline bool ScriptEngine::IsValid() const { return h != NULL; }
inline void ScriptEngine::LoadScript(const std::string &name,
                                     const std::string &code) {
  okError *error;
  if (!okScriptEngine_LoadScript(GetHandle(), name.c_str(), code.c_str(),
                                 &error))
...
inline ScriptValues ScriptEngine::RunScriptFunction(const std::string &name,
                                                    const ScriptValues &args) {
  okScriptValues_HANDLE retvals;
  okError *error;
  if (!okScriptEngine_RunScriptFunction(GetHandle(), name.c_str(), &retvals,
                                        args.h, &error))
    throw Impl::Error(error);

  return ScriptValues(retvals);
}
inline void ScriptEngine::RunScriptFunctionAsync(AsyncResultHandler &handler,
                                                 const std::string &name,
                                                 const ScriptValues &args) {
  okError *error;
  if (!okScriptEngine_RunScriptFunctionAsync(GetHandle(), AsyncResultCallback,
                                             &handler, name.c_str(), args.h,
                                             &error))
    throw Impl::Error(error);
}
inline ScriptEngine::~ScriptEngine() { okScriptEngine_Destruct(h); }

inline FrontPanelManager::FrontPanelManager(const std::string &realm) {
  h = okFrontPanelManager_Construct(
      reinterpret_cast<okFrontPanelManager_HANDLE>(this), realm.c_str());
}
